...
# Noting especially here: CONTROLLER_RESERVE seemingly is the RESERVE_POWER constant,
#  meaning it is how much reservation a creep can do per CLAIM part per tick.
